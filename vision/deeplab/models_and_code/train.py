...
def main(unused_argv):
  ...
  with tf.Graph().as_default() as graph:
    ...
    if FLAGS.quantize_delay_step >= 0:
      # use experimental to enable freeze_bn_delay
      contrib_quantize.experimental_create_training_graph(
        input_graph=graph, quant_delay=FLAGS.quantize_delay_step, freeze_bn_delay=FLAGS.quantize_delay_step)
    ...
    with contrib_tfprof.ProfileContext(
      ...
      # ref: https://github.com/tensorflow/tensorflow/blob/r1.14/tensorflow/contrib/slim/python/slim/learning.py#L533
      slim.learning.train(
          train_tensor,
