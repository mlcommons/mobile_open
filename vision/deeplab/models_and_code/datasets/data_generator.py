...
class Dataset(object):
  ...
  def __init__(self,
    ...
    """
    splits_to_sizes = _ADE20K_INFORMATION.splits_to_sizes
    ...
    self.num_of_classes = _ADE20K_INFORMATION.num_classes
    self.ignore_label = _ADE20K_INFORMATION.ignore_label
